...
var Card = (function() {
    ...
    Card = class Card {
        ...
        constructor(opts) {
            ...
            const toInitialize = QJ.isDOMElement(this.$container)
                ? this.$container
                : this.$container[0];
        ...
        render() {
            ...
            if (this.options.width) {
                ...
                $cardContainer.style.transform = `scale(${this.options.width /
                    350})`;
        ...
        validToggler(validatorName) {
            ...
            if (validatorName === 'cardExpiry') {
                ...
                isValid = val =>
                    Payment.fns.validateCardCVC(val, this.cardType);
            ...
            if (numbers.length >= 3) {
                numbers.forEach(function(item, idx) {
                    if (idx !== numbers.length - 1) {
                        return (numbers[idx] = numbers[idx].replace(
                            /\d/g,
                            mask
                        ));
                    }
